...
%          [ n               Ti  Vi p ]
par_true = [ log10(2.7e+11)  480  320 0.51 ]; 
%par_true = [ log10(1e+12)   410 10 0 ]; 
%par_true = [ log10(1e+12)   1010 683 0.237 ]; 
%par_true = [ log10(1e+9)     321 -20 0.75 ]; 
%par_true = [ log10(1e+11)    4500  250 0 ]; 
%par_true = [ log10(8e+10)   4750  400 0 ]; 
%par_true = [ log10(8e+11)   490  120 0 ];
%par_true = [ log10(1e+12)  320   140 0 ]; 
%par_true = [ log10(1e+11)  380   900 0 ]; 
  
function_options.Te=540;
...
initialSearch_parameters = [ log10(1e09)  300  0 0 ]; % initial guess for parameter values
