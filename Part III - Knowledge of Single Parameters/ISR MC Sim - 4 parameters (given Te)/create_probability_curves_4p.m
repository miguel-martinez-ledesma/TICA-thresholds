...
% given information of parameter Te
% -------------------------------------------------------------------------
...
save('Analyzed_Results_4p_given_Te.mat',...
...
clear all
load('Analyzed_Results_4p_given_Te.mat')

%Create Legend
legendstring={};
legendstring{1}=sprintf('Analyzed Results 4p given T_e');
