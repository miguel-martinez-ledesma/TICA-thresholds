...
% given information of parameter Ti
% -------------------------------------------------------------------------
...
save('Analyzed_Results_4p_given_Ti.mat',...
...
clear all
load('Analyzed_Results_4p_given_Ti.mat')

%Create Legend
legendstring={};
legendstring{1}=sprintf('Analyzed Results 4p given T_i');
