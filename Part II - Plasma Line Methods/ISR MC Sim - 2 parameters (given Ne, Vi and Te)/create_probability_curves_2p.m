...
% given information of parameters Ne, Vi and Te
% -------------------------------------------------------------------------
...
save('Analyzed_Results_2p_given_NeViTe.mat',...
...
clear all
load('Analyzed_Results_2p_given_NeViTe.mat')

%Create Legend
legendstring={};
legendstring{1}=sprintf('Analyzed Results 2p given N_e, V_i and T_e');
