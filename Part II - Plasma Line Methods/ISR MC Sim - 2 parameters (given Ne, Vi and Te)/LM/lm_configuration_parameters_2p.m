...
LM_configuration.num_var = 2;

%% Define Search Range

%                           [ Ti    p ]
LM_configuration.par_min =  [ 200   0 ]; % minimum expected parameter values
LM_configuration.par_max =  [ 6000  1 ]; % maximum expected parameter values
