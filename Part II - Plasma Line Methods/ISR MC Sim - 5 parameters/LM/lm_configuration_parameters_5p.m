...
LM_configuration.num_var = 5;

%% Define Search Range

%                           [ log10(n)      Te    Ti    Vi    p ]
LM_configuration.par_min =  [ log10(1e09)   200   200  -1000  0 ]; % minimum expected parameter values
LM_configuration.par_max =  [ log10(1e12)  6000  6000   1000  1 ]; % maximum expected parameter values
