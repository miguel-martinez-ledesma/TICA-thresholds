...
%% 
% Name: "run_MC_5p_noisy_multiple.m"
...
%          [ n               Te    Ti  Vi p ]
par_true = [ log10(2.7e+11)  520   480  320 0.51 ]; 
%par_true = [ log10(1e+12)   4050   410 10 0 ]; 
%par_true = [ log10(1e+12)   3050   1010 683 0.237 ]; 
%par_true = [ log10(1e+9)     705   321 -20 0.75 ]; 
%par_true = [ log10(1e+11)    450  4500  250 0 ]; 
%par_true = [ log10(8e+10)   3050  4750  400 0 ]; 
%par_true = [ log10(8e+11)   4720   490  120 0 ];
%par_true = [ log10(1e+12)  4720   320   140 0 ]; 
%par_true = [ log10(1e+11)  1720   380   900 0 ]; 
...
initialSearch_parameters = [ log10(1e09)  300  300  0 0 ]; % initial guess for parameter values
...
parameter_string={'Ne'; 'Te'; 'Ti'; 'Vi'; 'p '};
fprintf('\n');
