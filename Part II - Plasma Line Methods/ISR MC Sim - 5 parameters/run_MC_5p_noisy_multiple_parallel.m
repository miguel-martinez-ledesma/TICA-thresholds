...
%% 
% Name: "run_MC_5p_noisy_multiple_parallel.m"
...
lm_configuration_parameters_5p
...
initialSearch_parameters = [ log10((10^LM_configuration.par_max(1)-10^LM_configuration.par_min(1))*rand(1,Number_Random_Realizations)+10^LM_configuration.par_min(1));...
                    ((LM_configuration.par_max(2)-LM_configuration.par_min(2))*rand(1,Number_Random_Realizations)+LM_configuration.par_min(2));...
                    ((LM_configuration.par_max(3)-LM_configuration.par_min(3))*rand(1,Number_Random_Realizations)+LM_configuration.par_min(3));... 
                    ((LM_configuration.par_max(4)-LM_configuration.par_min(4))*rand(1,Number_Random_Realizations)+LM_configuration.par_min(4));... 
                    ((LM_configuration.par_max(5)-LM_configuration.par_min(5))*rand(1,Number_Random_Realizations)+LM_configuration.par_min(5))]; 

%% Loop For Different Segment Numbers
...
for fluctnum=1:length(Number_Fluctuations)
    ...
    for j=1:Number_InputParameters
        ...
        true_input_parameters(1)=log10(True_Parameters.Ne(j));
        true_input_parameters(2)=True_Parameters.Te(j);
        true_input_parameters(3)=True_Parameters.Ti(j);
        true_input_parameters(4)=True_Parameters.Vi(j);
        true_input_parameters(5)=True_Parameters.p(j);
        ...
        LM_results.fit_parameters(j,1:Number_Random_Realizations,1:5)= save_par(1:Number_Random_Realizations,1:5);
        ...
        LM_results.sigma_parameters(j,1:Number_Random_Realizations,1:5) = save_sigma_parameters(1:Number_Random_Realizations,1:5);
        ...
        %% SAVE RESULT
        if mod(j,200)==1
            save(sprintf('%ip_%.1ernd_%irep_%iparam.mat',Number_PlasmaParameters,FluctuationPercentage,Number_Random_Realizations,Number_InputParameters),...
