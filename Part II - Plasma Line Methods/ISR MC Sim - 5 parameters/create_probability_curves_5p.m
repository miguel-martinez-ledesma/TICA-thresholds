% create_probability_curves_5p.m
%
% Script to analyze Monte Carlo results of the ISR estimation simulation
% given NO information of plasma parameters
% -------------------------------------------------------------------------
...
clear all
load('Analyzed_Results_5p.mat')

%Create Legend
legendstring={};
legendstring{1}=sprintf('Analyzed Results 5p');
