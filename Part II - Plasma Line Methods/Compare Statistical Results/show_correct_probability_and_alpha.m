...
filenames_prob={ 'Graphically_Analyzed_Results_5p.mat'; ...
...
filenames_stat={ 'Analyzed_Results_5p.mat'; ...
...
string={};
string{1}='2 param. (T_i, p) given N_e, V_i, and T_e';
string{2}='2 param. (T_i, p) given N_e, V_i, and T_e/T_i';
string{3}='3 param. (T_e, T_i, p) given N_e and V_i';
string{4}='4 param. (N_e, T_e, T_i, p) given V_i';
string{5}='5 param. (N_e, T_e, T_i, V_i, p)';
