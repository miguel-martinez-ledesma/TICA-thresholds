...
%% 
% Name: "test_MC_2p_noisy_multiple.m"
...
function_options.Ne=1e+11;
function_options.Vi=0;
 
function_options.TeTi=Te/par_true(1);
...
initialSearch_parameters = [ 300 0 ]; % initial guess for parameter values
