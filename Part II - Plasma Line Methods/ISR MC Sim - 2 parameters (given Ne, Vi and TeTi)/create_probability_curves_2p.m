% create_probability_curves_2p.m
%
% Script to analyze Monte Carlo results of the ISR estimation simulation
% given information of parameters Ne, Vi and Te/Ti
% -------------------------------------------------------------------------
...
save('Analyzed_Results_2p_given_NeViTe_Ti.mat',...
...
clear all
load('Analyzed_Results_2p_given_NeViTe_Ti.mat')

%Create Legend
legendstring={};
legendstring{1}=sprintf('Analyzed Results 2p given N_e, V_i and T_e/T_i');
