...
% given information of parameters Ne and Vi
% -------------------------------------------------------------------------
...
save('Analyzed_Results_3p_given_NeVi.mat',...
...
clear all
load('Analyzed_Results_3p_given_NeVi.mat')

%Create Legend
legendstring={};
legendstring{1}=sprintf('Analyzed Results 3p given N_e and V_i');
