...
LM_configuration.num_var = 3;

%% Define Search Range

%                           [ Te    Ti    p ]
LM_configuration.par_min =  [ 200   200   0 ]; % minimum expected parameter values
LM_configuration.par_max =  [ 6000  6000  1 ]; % maximum expected parameter values
