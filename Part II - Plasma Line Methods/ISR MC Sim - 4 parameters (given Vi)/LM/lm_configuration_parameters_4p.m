...
%                           [ log10(n)      Ti   Te     p ]
LM_configuration.par_min =  [ log10(1e09)   200  200    0 ]; % minimum expected parameter values
LM_configuration.par_max =  [ log10(1e12)  6000 6000    1 ]; % maximum expected parameter values
