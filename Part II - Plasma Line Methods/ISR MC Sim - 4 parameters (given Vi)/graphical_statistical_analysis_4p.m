% graphical_statistical_analysis_4p.m
%
...
%% Configuration
save_filename='Graphically_Analyzed_Results_4p_given_Vi.mat';

PlasmaParameters={'Ne','Te','Ti','p'};
...
legendindex(end+1)=h;
legendstring{end+1}=sprintf('\\sigma_{est} (\\delta<<1) = \\delta/%.1f',divider);
...
X=[0:0.01:1];
Y=real(sqrt(0.9922-0.9414*X.^2)-0.2253*X);
