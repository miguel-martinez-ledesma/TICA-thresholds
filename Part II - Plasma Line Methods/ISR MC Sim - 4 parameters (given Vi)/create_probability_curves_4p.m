...
% given information of parameter Vi
% -------------------------------------------------------------------------
...
save('Analyzed_Results_4p_given_Vi.mat',...
...
clear all
load('Analyzed_Results_4p_given_Vi.mat')

%Create Legend
legendstring={};
legendstring{1}=sprintf('Analyzed Results 4p given V_i');
